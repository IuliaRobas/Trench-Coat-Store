...
public:
	...
	*/
	...
	Controller(VirtualRepository* r, ShoppingBasket* b, const TrenchCoatValidator& v) : repo{ r }, basket{ b }, validator{ v } {}
	...
	ShoppingBasket* getShoppingBasket()  { return basket; }
	std::vector <TrenchCoat> getCoatsInShoppingBasket() { return basket->getAll(); };
